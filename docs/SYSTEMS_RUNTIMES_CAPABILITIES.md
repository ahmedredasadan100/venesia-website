...
| Page Composition and Menus      | Specialized domain owners with aggregate atomic mutation RPCs; public Page Composition owns slot assignment, outer Layout, Container/Grid, available dimensions, and inter-region spacing                                                                                                                                          | Module presenters and Shared Module Presentation own internal visual composition and container-responsive behavior; neither side may take the other's geometry |

...
| Executable Governance           | Existing adoption manifests plus the Next compiled route manifest own typed applicability, executable binding proof, consumer reachability, and bidirectional route coverage                 | Raw source tokens, regex discovery, filenames, unused imports, and absence-based defaults are not governance evidence              |

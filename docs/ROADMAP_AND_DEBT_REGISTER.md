...
Executable governance is enforced inside the existing manifests and CI owners:
typed capability decisions, AST/import-graph Source Proof, explicit grouped-
consumer bindings, and bidirectional compiled-route registration are closed
contracts. Token/regex/filename/absence-based evidence is not an accepted
closure mechanism.

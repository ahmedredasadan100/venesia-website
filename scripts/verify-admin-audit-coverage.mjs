...
const TARGET_FILES = [
  ...
  "src/app/admin/content/topics/article-actions/create.ts",
  "src/app/admin/content/topics/article-actions/update.ts",
  "src/app/admin/content/topics/article-actions/status.ts",

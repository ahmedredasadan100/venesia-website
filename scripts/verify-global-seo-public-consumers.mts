...
assert.ok(read("src/components/FooterSocialBar.tsx").includes("usePublicBrand"));
...
console.log(`PASS Global SEO public consumers: ${GLOBAL_SEO_PUBLIC_CONSUMERS.length} metadata routes plus bounded Footer, Home Contact and PublicBrand consumption.`);

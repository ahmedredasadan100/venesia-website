...
check("review issues map to shared basic, FAQ, rich-media, and SEO targets", review.includes("AdminEntityReviewPanel") && ["content-title", "topic-faq-editor", "video_url", "gallery-editor", "content-seo-title"].every((target) => contentReviewCapability.includes(target)));

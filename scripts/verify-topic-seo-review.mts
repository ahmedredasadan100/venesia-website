...
check("publishing decisions join the balanced responsive dashboard grid", ["publication-status", "featured", "popular", "publish-date"].every((id) => publishingOptions.includes(`data-content-review-decision="${id}"`)) && review.includes("md:grid-cols-2") && review.includes("xl:grid-cols-3") && publishingOptions.includes('name="status"') && publishingOptions.includes('name="is_featured"') && publishingOptions.includes('name="is_popular"') && publishingOptions.includes("TopicDateLabelField"));
...
check("review overview exposes publish, featured, popular, dates, display, and score without owning submitted fields", ["publication-status", "featured", "popular", "publish-date"].every((id) => publishingOptions.includes(`data-content-review-decision="${id}"`)) && review.includes('data-content-review-decision="score"') && review.includes('data-content-review-decision="display-settings"') && review.includes('checked(form, "is_featured"') && review.includes('checked(form, "is_popular"') && review.includes("formatAuditTimestamp(updatedAt)") && editEditor.includes("updatedAt={topic.updated_at}") && !review.includes('name="updated_at"') && !review.includes('name="created_at"'));

...
check("package exposes static and PostgreSQL coordination commands", packageJson.scripts?.["verify:media-coordination-sql"] === "node scripts/verify-media-coordination-sql.mjs" && packageJson.scripts?.["verify:media-coordination-postgres"] === "node --experimental-strip-types scripts/verify-media-coordination-postgres.mts");
check("final local gate invokes coordination proof safely", packageJson.scripts?.["ci:check"]?.includes("verify:media-coordination-sql") && packageJson.scripts?.["ci:check"]?.includes("verify:media-coordination-postgres"));

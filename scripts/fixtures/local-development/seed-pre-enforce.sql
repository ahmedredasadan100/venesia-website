...
begin
  ...
  values
    ...
    ('development-news', 'Development News', 'Synthetic published news item.',
     '<p>Synthetic local development news content.</p>', '/images/placeholder.jpg', 'Synthetic news image',
     'Development Articles', 'development-articles', v_category_id,
     null, null, null, 'Development',
     '2026-03-01T09:00:00Z', 'news', 'published', 'Development News',
     'Synthetic published news item for local development.', 'development'),

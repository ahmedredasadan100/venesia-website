...
function assertSourceMarker(
  ...
  assert.ok(
    read(relativePath).replace(/\s+/gu, "").includes(marker.replace(/\s+/gu, "")),
...
const ADOPTION_MATRIX = {
  ...
  "media-sidebar": {
    ...
    syncMarker: 'saveModuleTemplateWithPageAssignments("media-sidebar"',
  ...
  "media-hub": {
    ...
    syncMarker: 'saveModuleTemplateWithPageAssignments("media-hub"',

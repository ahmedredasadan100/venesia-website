      ...
      <div className="relative z-10 flex min-h-screen items-center max-md:items-start max-md:pt-40">
        <div className="mx-auto grid w-full max-w-7xl items-center gap-10 px-6 pt-28 pb-20 max-md:pt-0 max-md:pb-24 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="min-w-0 text-right">
            ...
            <h1 className="max-w-none md:max-w-[12ch] lg:max-w-none lg:pb-[1.06em] text-4xl font-bold leading-[1.06] tracking-[-0.045em] text-white sm:text-5xl md:text-6xl lg:text-7xl">

...
import AdminTopicSearch from "./AdminTopicSearch";
...
export default function AdminTopicsFilters({
  q,
  status,
  category,
  period,
    ...
    >
      <div className="flex flex-wrap items-center justify-start gap-3">
        <div className="w-full xl:w-[520px]">
          <AdminTopicSearch defaultValue={q} />
        </div>
          <SelectBox
            value={sort}
            ...
            options={[
              ...
              ["created_asc", "الأقدم إنشاءً"],
              ["updated_desc", "الأحدث تعديلًا"],
              ["updated_asc", "الأقدم تعديلًا"],
              ["id_desc", "ID تنازلي"],
              ["id_asc", "ID تصاعدي"],
              ["title_asc", "العنوان أ - ي"],
              ["title_desc", "العنوان ي - أ"],
              ["category_asc", "التصنيف تصاعدي"],
              ["category_desc", "التصنيف تنازلي"],
              ["status_asc", "الحالة تصاعدي"],
              ["status_desc", "الحالة تنازلي"],
            ]}
          />

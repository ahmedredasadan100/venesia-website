...
export const ADMIN_NAVIGATION_REGISTRY: AdminNavigationItem[] = [
  ...
  },
  {
    ...
    children: [
      { id: "reports-overview", href: "/admin/reports", label: "نظرة عامة", icon: "•", order: 10, enabled: true, moduleKey: "reports-overview", permission: currentAdminAccess },
      { id: "reports-content", href: "/admin/reports/content", label: "المحتوى", icon: "•", order: 20, enabled: true, moduleKey: "reports-content", permission: currentAdminAccess },
      { id: "reports-projects", href: "/admin/reports/projects", label: "المشاريع", icon: "•", order: 30, enabled: true, moduleKey: "reports-projects", permission: currentAdminAccess },
      { id: "reports-analytics", href: "/admin/reports/analytics", label: "التحليلات", icon: "•", order: 40, enabled: true, moduleKey: "reports-analytics", permission: currentAdminAccess },
      { id: "reports-seo", href: "/admin/reports/seo", label: "SEO", icon: "•", order: 50, enabled: true, moduleKey: "reports-seo", permission: currentAdminAccess },
      { id: "reports-media", href: "/admin/reports/media", label: "الميديا", icon: "•", order: 60, enabled: true, moduleKey: "reports-media", permission: currentAdminAccess },
      { id: "reports-media-quality", href: "/admin/reports/topics-without-image", label: "موضوعات بلا صورة", icon: "•", order: 65, enabled: true, moduleKey: "reports-media-quality", permission: currentAdminAccess },
      { id: "reports-publishing", href: "/admin/reports/publishing", label: "النشر", icon: "•", order: 70, enabled: true, moduleKey: "reports-publishing", permission: currentAdminAccess },
      { id: "reports-audit", href: "/admin/reports/audit", label: "النشاط", icon: "•", order: 80, enabled: true, moduleKey: "reports-audit", permission: currentAdminAccess },
      { id: "reports-system", href: "/admin/reports/system", label: "النظام", icon: "•", order: 90, enabled: true, moduleKey: "reports-system", permission: currentAdminAccess },
      { id: "reports-business", href: "/admin/reports/business", label: "الأعمال", icon: "•", order: 100, enabled: true, moduleKey: "reports-business", permission: currentAdminAccess },
    ],
  },

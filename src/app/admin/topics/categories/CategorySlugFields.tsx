    ...
    <>
      <div className="space-y-2">
        ...
        <input
          ...
          dir="rtl"
          className="w-full rounded-2xl border border-white/10 bg-black/30 px-4 py-3 text-right text-sm text-white outline-none placeholder:text-white/30 focus:border-[#D8B87A]/45"
        />
      </div>
      ...
      <div className="space-y-2 text-right">
        ...
        <div className="flex flex-row-reverse items-center gap-2">
          <input
            ...
            dir="ltr"
            className="min-w-0 flex-1 rounded-2xl border border-white/10 bg-black/30 px-4 py-3 text-left font-en text-sm text-white outline-none placeholder:text-white/30 focus:border-[#D8B87A]/45"
          />
          <button
            type="button"
            onClick={() => {
        ...
        <p className="text-right text-[11px] text-white/30">توليد الـ Slug لا يحفظ تلقائيًا. اضغط حفظ لتطبيق التعديل.</p>
      </div>
    </>
  );
}

...
export const MEDIA_CONTENT_TYPE_BADGE_STYLES: Record<MediaListContentType, MediaContentTypeBadgeStyle> = {
  news: {
    icon: "◈",
...
export function isKnownMediaContentType(value?: string | null): value is MediaListContentType {
